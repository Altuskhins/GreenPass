module singboxextended

go 1.26.4

require (
	combinedtunnel v0.0.0
...
replace combinedtunnel => ../turnlib
...
replace github.com/openlibrecommunity/olcrtc => ../turnlib/olcrtc
...
require (
	...
	github.com/openlibrecommunity/olcrtc v0.0.0 // indirect
